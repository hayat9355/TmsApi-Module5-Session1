...
var context = scope.ServiceProvider.GetRequiredService<TmsDbContext>();
    ...
    {
        // 42P07 is the Postgres code for "relation already exists".
        // We catch it here so the app doesn't crash and "just passes".
        Console.WriteLine("--> Database tables already exist. Skipping migration execution.");
    }
